<%@ Control Language="vb" Inherits="DNNStuff.SQLViewPro.EditConnection" CodeBehind="EditConnection.ascx.vb" AutoEventWireup="false" Explicit="True" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div class="dnnForm dnnClear">
    ...
    <div class="dnnFormItem">
        ...
        <asp:CustomValidator ID="vldConnectionStringValid" runat="server" ControlToValidate="txtConnectionString" EnableClientScript="False" Display="Dynamic" ErrorMessage="Connection String is invalid" />
    </div>
