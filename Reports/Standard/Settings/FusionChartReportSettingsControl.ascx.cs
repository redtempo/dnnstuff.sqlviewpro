...
namespace DNNStuff.SQLViewPro.StandardReports
{
	...
	public partial class FusionChartReportSettingsControl : ReportSettingsControlBase
	{
...
#region  Base Method Implementations
		...
		public override string UpdateSettings()
		{
			...
			var obj = new FusionChartReportSettings();
			obj.ChartType = ddlChartType.SelectedValue;
			
			// update properties
			cpvMain.SetProperties(obj);
			
			return Serialization.SerializeObject(obj, typeof(FusionChartReportSettings));
		...
		public override void LoadSettings(string settings)
		{
			...
			{
				ReportSettings = (FusionChartReportSettings) (Serialization.DeserializeObject(settings, typeof(FusionChartReportSettings)));
			}
		}
		
		private Settings FusionChartSettings()
		{
		...
		private string SettingsFilename()
		{
			...
			return System.IO.Path.Combine(MapPath(propertiesFolder), "FusionChartReport.xml");
		}
...
#region  Settings
	...
	[XmlRootAttribute(ElementName = "Settings", IsNullable = false)]public class FusionChartReportSettings
	{
		public FusionChartReportSettings()
		{
