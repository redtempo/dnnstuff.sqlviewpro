...
<div class="dnnForm" id="panels-settings">
    ...
    <fieldset class="dnnClear">
        <div class="dnnFormItem">
            ...
            <div class="normal">
                The Fusion Chart report is based on the free charting component &copy; 2011 <a href="http://www.fusioncharts.com/free/">FusionCharts Technologies LLP.</a> used under the <a href="http://www.gnu.org/copyleft/gpl.html">MIT license</a></div>
        </div>
    </fieldset>
</div>
