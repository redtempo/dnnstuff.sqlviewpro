...
namespace DNNStuff.SQLViewPro.StandardReports
{
	...
	public partial class HtmlChartReportSettingsControl : ReportSettingsControlBase
	{
		...
		protected override string LocalResourceFile
		{
			get
			{
				return ResolveUrl("App_LocalResources/HtmlChartReportSettingsControl");
			}
		}

	    private HtmlChartReportSettings ReportSettings { get; set; } = new HtmlChartReportSettings();
...
#region  Base Method Implementations
		private void InitSettings()
		{
			...
			cpvMain.Settings = HtmlChartSettings();
		...
		public override string UpdateSettings()
		{
			...
			var obj = new HtmlChartReportSettings();
			obj.ChartType = ddlChartType.SelectedValue;
			
			// update properties
			cpvMain.SetProperties(obj);
			
			return Serialization.SerializeObject(obj, typeof(HtmlChartReportSettings));
			
		}
		
		public override void LoadSettings(string settings)
		{
			ReportSettings = new HtmlChartReportSettings();
			if (!string.IsNullOrEmpty(settings))
			{
				ReportSettings = (HtmlChartReportSettings) (Serialization.DeserializeObject(settings, typeof(HtmlChartReportSettings)));
			}
		}
		
		private Settings HtmlChartSettings()
		{
		...
		private string SettingsFilename()
		{
			...
			return System.IO.Path.Combine(MapPath(propertiesFolder), "HtmlChartReport.xml");
		}
...
#region  Settings
	...
	[XmlRootAttribute(ElementName = "Settings", IsNullable = false)]public class HtmlChartReportSettings
	{
		public HtmlChartReportSettings()
		{
