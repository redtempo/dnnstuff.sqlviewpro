<%@ Control Language="C#" Inherits="DNNStuff.SQLViewPro.StandardReports.Html5ChartReportSettingsControl" CodeBehind="Html5ChartReportSettingsControl.ascx.cs" AutoEventWireup="true" Explicit="True" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" EnableViewState="false" %>
...
<div class="dnnForm" id="panels-settings">
    ...
    <fieldset class="dnnClear">
        <div class="dnnFormItem">
            ...
            <div class="normal">
                The Fusion Chart report is based on the free charting component &copy; 2011 <a href="http://www.Html5Charts.com/free/">Html5Charts Technologies LLP.</a> used under the <a href="http://www.gnu.org/copyleft/gpl.html">MIT license</a></div>
        </div>
    </fieldset>
</div>
