...
#region  Base Method Implementations
		...
		{
			ReportExtra = (Html5ChartReportSettings) (Serialization.DeserializeObject(settings.ReportConfig, typeof(Html5ChartReportSettings)));
		}
#endregion
...
#region  Chart
		...
		private void RenderChart()
		{
			...
			sb.AppendFormat("   var chart = new Html5Charts(\"{0}\", \"ChartId\", \"{1}\", \"{2}\");", ResolveUrl("Charts/FCF_" + ReportExtra.ChartType + ".swf"), ReportExtra.ChartWidth, ReportExtra.ChartHeight);
		...
		{
			Page.ClientScript.RegisterClientScriptBlock(GetType(), Unique("RenderHtml5Chart"), _reportScript);
		}
	}
