/**
 * Html5Charts: Flash Player detection and Chart embedding.
 * Version 1.2.3F ( 22 November 2008) - Specialized for Html5ChartsFREE 
...
if(typeof infosoftglobal.Html5ChartsUtil == "undefined") infosoftglobal.Html5ChartsUtil = new Object();
infosoftglobal.Html5Charts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	this.installedVer = infosoftglobal.Html5ChartsUtil.getPlayerVersion();
	
	if (!window.opera && document.all && this.installedVer.major > 7) {
		// Only add the onunload cleanup if the Flash Player version supports External Interface and we are in IE
		infosoftglobal.Html5Charts.doPrepUnload = true;
	}
}

infosoftglobal.Html5Charts.prototype = {
	...
	setDataURL: function(strDataURL){
		...
		if (this.initialDataSet==false){
			...
			var chartObj = infosoftglobal.Html5ChartsUtil.getChartObject(this.getAttribute('id'));
...
/* ---- detection functions ---- */
infosoftglobal.Html5ChartsUtil.getPlayerVersion = function(){
...
infosoftglobal.Html5ChartsUtil.cleanupSWFs = function() {
...
// Fixes bug in fp9
if (infosoftglobal.Html5Charts.doPrepUnload) {
	if (!infosoftglobal.unloadSet) {
		infosoftglobal.Html5ChartsUtil.prepUnload = function() {
			__flash_unloadHandler = function(){};
			__flash_savedUnloadHandler = function(){};
			window.attachEvent("onunload", infosoftglobal.Html5ChartsUtil.cleanupSWFs);
		}
		window.attachEvent("onbeforeunload", infosoftglobal.Html5ChartsUtil.prepUnload);
...
infosoftglobal.Html5ChartsUtil.getChartObject = function(id)
{
  var chartRef=null;
...
/*
 Function to update chart's data at client side (FOR Html5Charts vFREE and 2.x
*/
infosoftglobal.Html5ChartsUtil.updateChartXML = function(chartId, strXML){
	//Get reference to chart object				
	var chartObj = infosoftglobal.Html5ChartsUtil.getChartObject(chartId);		
	//Set dataURL to null
...
var getChartFromId = infosoftglobal.Html5ChartsUtil.getChartObject;
var updateChartXML = infosoftglobal.Html5ChartsUtil.updateChartXML;
var Html5Charts = infosoftglobal.Html5Charts;