<%@ Control Language="C#" Inherits="DNNStuff.SQLViewPro.StandardParameters.ListBoxParameterSettingsControl" CodeBehind="ListBoxParameterSettingsControl.ascx.cs" AutoEventWireup="true" Explicit="True" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
