...
Namespace DNNStuff.SQLViewPro.StandardParameters
    ...
    Partial Class DropDownListParameterSettingsControl
...
#Region " Base Method Implementations"
        ...
        Public Overrides Function UpdateSettings() As String
            ...
            Dim obj As DropDownListParameterSettings = New DropDownListParameterSettings
            With obj
            ...
            Return SerializeObject(obj, GetType(DropDownListParameterSettings))

        End Function

        Public Overrides Sub LoadSettings(ByVal settings As String)
            Dim obj As New DropDownListParameterSettings
            If settings IsNot Nothing Then
                obj = DirectCast(DeserializeObject(settings, GetType(DropDownListParameterSettings)), DropDownListParameterSettings)
            End If
            With obj
